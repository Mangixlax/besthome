...
declare namespace ScrollMagic {
  ...
  export class Scene {
    ...
    setTween(tweenObject: gsap.core.Timeline | gsap.core.Tween): Scene
    setTween(tweenObject: string | HTMLElement | gsap.core.Tween, params: Object): Scene
    setTween(
      tweenObject: string | HTMLElement | gsap.core.Tween,
      duration: number,
      params: Object,
    ): Scene
...
declare module 'vue/types/vue' {
  interface Vue {
    $scrollmagic: {
      controller_: ScrollMagic.Controller
      /** Add one ore more scene(s) to the controller. */
      addScene(newScene: ScrollMagic.Scene | ScrollMagic.Scene[]): void
      /** Destroy the controller, all scenes and everything. */
      destroy: (resetScenes: boolean) => void
      /** Remove one ore more scene(s) from the controller. */
      removeScene: (scene: ScrollMagic.Scene | ScrollMagic.Scene[]) => void
      /** Scroll to a numeric scroll offset, a DOM element, the start of a scene or provide an alternate method for scrolling.  */
      scrollTo(
        scrollTarget: number | string | HTMLElement | Function | ScrollMagic.Scene,
        additionalParameter?: any,
      ): void
